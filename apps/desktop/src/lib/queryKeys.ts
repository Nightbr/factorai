...
export const queryKeys = {
	...
	/** One media file's probe (F7, ADR-0057) — the verdict and the URL, never the
	 *  bytes. Its own namespace for the reason `image` and `pdf` have one, and
	 *  the entry a reopen must refetch: publishing the file is what makes that
	 *  URL fetchable. */
