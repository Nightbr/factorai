...
Switchboard launches `claude` inside an in-app xterm.js terminal backed
...
- `specs/annex-A-tolaria-patterns.md` § A.1 (binary discovery — same
  problem space)
